...
`r knitr::write_bib(c(.packages(), "circlize"), "book.bib")`.
...
pacviz::pacman(cars$speed,cars$dist,
            'Example 1',
            'units',
            'Axis Label')
```

```{r, exxample1, out.width="100%", dev='svglite', fig.cap='Graphical result of Example 1. We can see that the units are attached to the residual standard deviation as well as the angular axis markings. Make note that if you want a space between the numerical value and the units to add a space in the character string.', fig.align='center', echo=FALSE}
knitr::include_graphics("examples/figures/fig1.png")
```
\newpage
...
pacman(x,y, 'Example 2',
            ...
            standardize=TRUE)
```
```{r, out.width="100%", fig.cap='Graphical result of Example 2.', dev='svglite', fig.align='center', echo=FALSE}
knitr::include_graphics("examples/figures/fig2.png")
```
\newpage
...
pacman(x,y, 'Example 3',
            ...
            color1="darksalmon")
```
```{r, out.width="100%", fig.cap='Graphical result of Example 3.', dev='svglite', fig.align='center', echo=FALSE}
knitr::include_graphics("examples/figures/fig3.png")
```
